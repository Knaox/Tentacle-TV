 ...
 *
 * INVARIANT : voir le bandeau de `./dark.ts`. L'import de `BRAND` doit rester
 * `@tentacle-tv/shared/theme` (objet mutable), sinon l'accent clair cesse de
 * suivre la marque admin — c'est le chemin qui casse en PREMIER, puisqu'il est
 * DÉRIVÉ et non lu directement.
 */
