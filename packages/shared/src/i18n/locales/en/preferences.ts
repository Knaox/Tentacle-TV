export default {
  ...
  persoHomeTitle: "Home",
  persoHomeCaption: "The banner, row order and card size of your home screen.",
  persoHeroMode: "Main banner",
  persoHeroResume: "Resume",
  persoHeroRandom: "Random",
  persoHeroReco: "Recommendation",
  persoHeroFixed: "Fixed pick",
  persoHeroFixedPick: "Pick from your favorites",
  persoHeroFixedEmpty: "Add a title to your favorites first to pin it here.",
  persoDensity: "Card density",
  persoDensityCompact: "Compact",
  persoDensityNormal: "Normal",
  ...
  persoRecoCaption: "What the engine may suggest, and what it is allowed to use.",
  persoRecoPersonalized: "Personalized recommendations",
  persoRecoPersonalizedHint: "Suggestions built from your ratings, favorites and watch history.",
  persoRecoVigie: "Include titles outside your library",
  persoRecoVigieHint: "Also suggests titles requestable through the Vigie catalog.",
  persoRecoCommunity: "Community recommendations",
  persoRecoCommunityHint: "The \"Tentacle users also watch\" row.",
  persoRecoShareHistory: "My history feeds community recommendations",
  persoRecoShareHistoryHint: "When off, your watch history stays out of shared computations. No pair is ever shown below five accounts.",
  persoBalance: "Suggestion balance",
  persoBalanceHint: "Towards \"Safe\", titles close to your taste; towards \"Adventurous\", more discoveries.",
  persoBalanceSafe: "Safe",
  persoBalanceAdventurous: "Adventurous",
  persoResetProfile: "Reset my taste profile",
  persoResetProfileBody: "The computed profile and cached rows will be erased, then rebuilt from your ratings and history. Your ratings, favorites and exclusions are kept.",
  persoResetProfileConfirm: "Reset",
  persoAccountsTitle: "Linked accounts",
  persoAccountsCaption: "Where your ratings travel, and under which identity.",
  persoTmdbTitle: "TMDB (guest session)",
  persoTmdbHint: "Your ratings are sent to TMDB ANONYMOUSLY, through a guest session tied to this account — never attached to a TMDB account. One session, shared across your devices.",
  persoTmdbUnavailable: "This server has no TMDB key: ratings stay local.",
  persoTmdbLinked: "Guest session active",
  persoTmdbCreate: "Enable",
  persoAnilistTitle: "AniList",
  persoAnilistHint: "Link your account so your anime ratings land in your AniList lists.",
  persoAnilistUnavailable: "This server has no AniList client configured.",
  persoAnilistLinked: "Account linked",
  persoAnilistLink: "Link my AniList account",
  persoUnlink: "Unlink",
  persoSyncTitle: "Rating sync",
  ...
  persoShareTitle: "Sharing",
  persoShareCaption: "A public, revocable link to your liked titles.",
  persoShareActive: "A share link is active — manage or revoke it.",
  persoShareInactive: "No active link. Generate one to share your liked titles.",
  persoShareManage: "Manage link",
  sectionHelp: "Help",
