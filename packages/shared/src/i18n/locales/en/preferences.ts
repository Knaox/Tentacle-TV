export default {
  ...
  persoHeroFixedNone: "No title chosen",
  ...
  persoBalanceValue: "{{value}} of 100",
  ...
  // Android TV device setting (TVDevicePlaybackSection): ExoPlayer tunneling.
  exoTunnelingLabel: "Tunneled decoding",
  exoTunnelingHint:
