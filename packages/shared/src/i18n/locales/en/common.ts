export default {
  ...
  searchResultCount: "{{count}} title",
  searchResultCount_other: "{{count}} titles",
  noResultsFor: "Nothing matches “{{query}}” in {{name}}.",
  tryCorrection: "Try “{{term}}”",
  searchEverywhere: "Search all of Tentacle",
  resetSearchAndFilters: "Clear search and filters",
  myList: "My List",
  ...
  invite: "Invite",
  you: "you",
  shareMyFavorites: "Share my liked titles",
  shareFavoritesLinkDescription: "Anyone with the link will see your favorites and catalog likes — titles only, nothing else.",
  sharedFavoritesBy: "{{name}}'s liked titles",
  sharedOffLibraryBadge: "Catalog",
