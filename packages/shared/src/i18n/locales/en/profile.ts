export default {
  ...
  avatarUpdateFailed: "Could not update the profile picture",
  ...
  changeServerMessage: "You will be signed out and returned to the server setup screen. Continue?",
  changeServerConfirm: "Change server",
  settings: "Settings",
  account: "Account",
  help: "Help",
  ...
  playback: "Playback",
  playbackSubtitle: "Default audio and subtitles",
