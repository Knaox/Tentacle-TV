...
export default {
  ...
  switchedOfflineDeviceTitle: "Switched offline",
  ...
  audioLanguageDefault: "Default language",
  subtitlesAllKeptHint: "Every text subtitle is kept, in every language.",
  imageSubsHint: "Image subtitles (PGS, VobSub) cannot be kept: only burning them in embeds them.",
  ...
  networkOther: "Other",
  reasonTimeout: "The server does not answer in time: the connection is too weak.",
