export default {
  ...
  activeCount_one: "{{count}} transfer in progress",
  activeCount_other: "{{count}} transfers in progress",
  errorAudio: "Version without an audio track",
  errorDiskFull: "Disk full",
  errorUnavailable: "Unavailable on the server",
  ...
  filterAll: "All",
  heroLabel: "On this device",
  heroLatest: "Last added",
  heroResume: "Resume",
  deviceTitles_one: "{{count}} title",
  deviceTitles_other: "{{count}} titles",
  deviceSpace: "{{size}} used",
  deviceLastAdded: "Last added: {{name}}",
  offlineEmptyOnlineMessage: "Nothing is kept on this machine yet. Download a title from its page and it will stay playable without the server.",
  ...
  emptyAction: "Browse the library",
