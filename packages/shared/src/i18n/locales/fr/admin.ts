export default {
  ...
  tmdbKeyTitle: "Clé TMDB manquante",
  tmdbKeyMessage: "Sans clé TMDB, les recommandations restent génériques pour tous les comptes : ni « Pour vous », ni profil de goût, ni filtres par plateforme.",
  tmdbKeyAction: "Ajouter la clé TMDB",
  tmdbKeyDismiss: "Masquer",
  ...
  bandwidthPoolsHelp:
    "Réseau local ou extérieur : même règle que la lecture directe — un client dont l'adresse IP est privée (192.168.x.x, 10.x.x.x…) est sur le réseau local, tout autre est à l'extérieur ; le « + » de la ligne « Réseau local » permet d'y ajouter des adresses. Chaque plafond est indépendant, illimité par défaut.",
  ...
  bandwidthIpsHelp: "Ces adresses sont traitées comme le réseau local, quoi qu'en dise leur plage — plafond posé ou non : si seul l'extérieur est limité, elles ne le sont pas. Une adresse IPv4 ou IPv6, ou une plage IPv4 (203.0.113.0/24).",
  bandwidthAddIp: "Ajouter une adresse à traiter comme locale",
  bandwidthIpPlaceholder: "203.0.113.5 ou 203.0.113.0/24",
