export default {
  ...
  gifsTitle: "GIFs du chat (Tenor)",
  gifsDescription: "Active la recherche et l'envoi de GIFs dans le chat Watch Together via l'API Tenor de Google. La clé reste côté serveur et n'est jamais exposée aux clients.",
  gifsStatusEnvFallback: "Clé fournie par la variable d'environnement TENOR_API_KEY.",
  gifsKeyLabel: "Clé API Tenor",
  gifsKeyPlaceholder: "Collez votre clé API…",
  gifsSaveAndTest: "Tester et sauvegarder",
  gifsClearKey: "Effacer la clé",
  gifsKeyInvalid: "Clé refusée par Tenor — vérifiez-la.",
  gifsCleared: "Clé effacée",
  gifsHowTo: "Comment obtenir une clé (gratuite)",
  gifsStep1: "Ouvrez la Google Cloud Console et créez (ou sélectionnez) un projet.",
  gifsStep2: "Activez l'API « Tenor API » dans la bibliothèque d'APIs.",
  gifsStep3: "Créez une clé API dans « Identifiants », puis collez-la ici.",
  gifsOpenConsole: "Ouvrir la Google Cloud Console",
  gifsOpenDocs: "Guide officiel Tenor",
} as const;
