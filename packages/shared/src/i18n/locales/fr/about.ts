export default {
  ...
  description: "Tentacle est un client multimédia premium conçu pour offrir une expérience de streaming fluide et élégante. Disponible sur Web, Desktop, Mobile et TV, il permet de parcourir, rechercher et regarder votre bibliothèque de médias depuis n'importe quel appareil.",
  ...
  creditsIntro: "Tentacle est construit grâce à de nombreux projets open-source. Merci à toutes les communautés qui rendent ce projet possible.",
  technologies: "Technologies",
  compatibleServices: "Services compatibles",
  license: "Licence",
  licenseText: "Tentacle est distribué sous licence MIT. Les bibliothèques tierces utilisées sont soumises à leurs licences respectives (MIT, Apache 2.0, BSD, etc.).",
