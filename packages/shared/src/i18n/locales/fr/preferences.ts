export default {
  ...
  persoHomeTitle: "Accueil",
  persoHomeCaption: "Le bandeau, l'ordre des rangées et la taille des cartes de votre accueil.",
  persoHeroMode: "Bandeau principal",
  persoHeroResume: "Reprendre",
  persoHeroRandom: "Aléatoire",
  persoHeroReco: "Recommandation",
  persoHeroFixed: "Sélection fixe",
  persoHeroFixedPick: "Choisir parmi vos favoris",
  persoHeroFixedEmpty: "Ajoutez d'abord un titre à vos favoris pour pouvoir l'épingler ici.",
  persoDensity: "Densité des cartes",
  persoDensityCompact: "Compacte",
  persoDensityNormal: "Normale",
  persoDensityLarge: "Large",
  ...
  persoRecoCaption: "Ce que le moteur peut vous proposer, et ce qu'il a le droit d'utiliser.",
  persoRecoPersonalized: "Recommandations personnalisées",
  persoRecoPersonalizedHint: "Des suggestions construites sur vos notes, favoris et visionnages.",
  persoRecoVigie: "Inclure les titres hors bibliothèque",
  persoRecoVigieHint: "Propose aussi des titres demandables via le catalogue Vigie.",
  persoRecoCommunity: "Recommandations communautaires",
  persoRecoCommunityHint: "La rangée « Les utilisateurs de Tentacle regardent aussi ».",
  persoRecoShareHistory: "Mon historique alimente les recommandations communautaires",
  persoRecoShareHistoryHint: "Désactivé, votre visionnage n'entre plus dans les calculs communs. Aucune paire n'est jamais montrée sous cinq comptes.",
  persoBalance: "Équilibre des suggestions",
  persoBalanceHint: "Vers « Sûr », des valeurs proches de vos goûts ; vers « Aventureux », plus de découvertes.",
  persoBalanceSafe: "Sûr",
  persoBalanceAdventurous: "Aventureux",
  persoResetProfile: "Réinitialiser mon profil de goût",
  persoResetProfileBody: "Le profil calculé et les rangées en cache seront effacés, puis reconstruits depuis vos notes et votre historique. Vos notes, favoris et exclusions sont conservés.",
  persoResetProfileConfirm: "Réinitialiser",
  persoAccountsTitle: "Comptes liés",
  persoAccountsCaption: "Où vos notes voyagent, et sous quelle identité.",
  persoTmdbTitle: "TMDB (session invitée)",
  persoTmdbHint: "Vos notes sont envoyées ANONYMEMENT à TMDB, via une session invitée propre à ce compte — jamais rattachées à un compte TMDB. Une seule session, partagée entre vos appareils.",
  persoTmdbUnavailable: "Ce serveur n'a pas de clé TMDB : les notes restent locales.",
  persoTmdbLinked: "Session invitée active",
  persoTmdbCreate: "Activer",
  persoAnilistTitle: "AniList",
  persoAnilistHint: "Liez votre compte pour que vos notes d'animés se retrouvent dans vos listes AniList.",
  persoAnilistUnavailable: "Ce serveur n'a pas de client AniList configuré.",
  persoAnilistLinked: "Compte lié",
  persoAnilistLink: "Lier mon compte AniList",
  persoUnlink: "Délier",
  persoSyncTitle: "Synchronisation des notes",
  ...
  persoShareTitle: "Partage",
  persoShareCaption: "Un lien public, révocable, vers vos titres likés.",
  persoShareActive: "Un lien de partage est actif — gérez-le ou révoquez-le.",
  persoShareInactive: "Aucun lien actif. Générez-en un pour partager vos titres likés.",
  persoShareManage: "Gérer le lien",
  sectionHelp: "Aide",
