export default {
  ...
  offlineReasonNetwork: "Cet appareil n'a aucun réseau.",
  ...
  activeCount_one: "{{count}} transfert en cours",
  activeCount_other: "{{count}} transferts en cours",
  ...
  filterAll: "Tout",
  heroLabel: "Sur cet appareil",
  heroLatest: "Dernier ajout",
  heroResume: "Reprendre",
  deviceTitles_one: "{{count}} titre",
  deviceTitles_other: "{{count}} titres",
  deviceSpace: "{{size}} occupés",
  deviceLastAdded: "Dernier ajout : {{name}}",
  offlineEmptyOnlineMessage: "Rien n'est encore gardé sur cette machine. Téléchargez un titre depuis sa fiche : il restera lisible sans le serveur.",
  ...
  emptyAction: "Parcourir la bibliothèque",
