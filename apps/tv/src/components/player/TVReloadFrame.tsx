 ...
 * qualité) : AVPlayer remplace l'item / passe au noir le temps du re-buffer.
 * Vignette trickplay de la position courante (basse résolution mais continuité
 * visuelle), avec le spinner par-dessus. No-op sans trickplay.
 */
