    ...
    >
      ...
      <LinearGradient
        ...
        style={{
          ...
          paddingBottom: TV_OSD.voileHaut.debordPx,
        }}
      >
        <View style={{ flexDirection: "row", alignItems: "flex-start" }}>
          <Focusable variant="playerButton" focusRadius={TV_OSD.boutonSecondaire / 2} phantomPressGuard ref={focus.registerButton("back")} onPress={onBack} {...focus.buttonProps("back")}>
            <View style={{ width: TV_OSD.boutonSecondaire, height: TV_OSD.boutonSecondaire, borderRadius: TV_OSD.boutonSecondaire / 2, alignItems: "center", justifyContent: "center" }}>
              <BackIcon size={28} color={Colors.textPrimary} />
            </View>
          </Focusable>
          <View style={{ marginLeft: 24, flex: 1 }}>
            <Text numberOfLines={1} style={{
              color: Colors.textPrimary, fontSize: TV_OSD.titreTaille, fontWeight: "600",
              letterSpacing: -0.4,
            }}>
              {title}
            </Text>
            {subtitle ? (
              <Text numberOfLines={1} style={{
                color: TV_OSD.sousTitreTeinte, fontSize: TV_OSD.sousTitreTaille,
      ...
      <LinearGradient
        ...
        style={{
          ...
          paddingTop: TV_OSD.voileBas.debordPx,
        }}
      >
        ...
        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 24 }}>
          ...
          <View style={{ flex: 1, marginHorizontal: 16 }}>
            <View style={{
              height: TV_OSD.barre.hauteur, backgroundColor: TV_OSD.barre.fond,
              borderRadius: TV_OSD.barre.hauteur / 2, overflow: "hidden",
            }}>
              {/* Buffer bar */}
              <View style={{
                ...
                backgroundColor: TV_OSD.barre.tampon, borderRadius: TV_OSD.barre.hauteur / 2,
              }} />
              ...
              <View style={{
                height: TV_OSD.barre.hauteur, width: `${Math.min(progress, 100)}%`,
                borderRadius: TV_OSD.barre.hauteur / 2, overflow: "hidden",
              }}>
                <LinearGradient
            ...
            <View style={{
              position: "absolute", top: -(TV_OSD.barre.pastille - TV_OSD.barre.hauteur) / 2,
              left: `${Math.min(progress, 100)}%`,
              marginLeft: -TV_OSD.barre.pastille / 2,
              width: TV_OSD.barre.pastille, height: TV_OSD.barre.pastille,
              borderRadius: TV_OSD.barre.pastille / 2,
            ...
            {scrubbing && (
              <View style={{
                position: "absolute", top: -(TV_OSD.barre.fantome - TV_OSD.barre.hauteur) / 2,
                left: `${scrubPct}%`,
                marginLeft: -TV_OSD.barre.fantome / 2,
                width: TV_OSD.barre.fantome, height: TV_OSD.barre.fantome,
                borderRadius: TV_OSD.barre.fantome / 2,
        ...
        <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", gap: 32 }}>
          {hasPreviousEpisode && (
            <Focusable variant="playerButton" focusRadius={TV_OSD.boutonSecondaire / 2} phantomPressGuard ref={focus.registerButton("prev")} onPress={onPrevEpisode} {...focus.buttonProps("prev")}>
              <View style={{ width: TV_OSD.boutonSecondaire, height: TV_OSD.boutonSecondaire, borderRadius: TV_OSD.boutonSecondaire / 2, alignItems: "center", justifyContent: "center" }}>
          ...
          <Focusable variant="playerButton" focusRadius={TV_OSD.boutonSecondaire / 2} phantomPressGuard ref={focus.registerButton("skipback")} onPress={onSkipBack} {...focus.buttonProps("skipback")}>
            <View style={{ width: TV_OSD.boutonSecondaire, height: TV_OSD.boutonSecondaire, borderRadius: TV_OSD.boutonSecondaire / 2, alignItems: "center", justifyContent: "center" }}>
          ...
          <Focusable
            variant="playerButton" focusRadius={TV_OSD.boutonPrincipal / 2} phantomPressGuard ref={focus.registerButton("playpause")} onPress={onPlayPause}
            {...focus.buttonProps("playpause")}
          >
            {/* LA commande : un disque plein de 84 — la seule action primaire. */}
            <View style={{
              width: TV_OSD.boutonPrincipal, height: TV_OSD.boutonPrincipal,
              borderRadius: TV_OSD.boutonPrincipal / 2,
          ...
          <Focusable variant="playerButton" focusRadius={TV_OSD.boutonSecondaire / 2} phantomPressGuard ref={focus.registerButton("skipforward")} onPress={onSkipForward} {...focus.buttonProps("skipforward")}>
            <View style={{ width: TV_OSD.boutonSecondaire, height: TV_OSD.boutonSecondaire, borderRadius: TV_OSD.boutonSecondaire / 2, alignItems: "center", justifyContent: "center" }}>
          ...
          <Focusable variant="playerButton" focusRadius={TV_OSD.boutonSecondaire / 2} phantomPressGuard ref={focus.registerButton("scrub")} onPress={onScrub} {...focus.buttonProps("scrub")}>
            <View style={{ width: TV_OSD.boutonSecondaire, height: TV_OSD.boutonSecondaire, borderRadius: TV_OSD.boutonSecondaire / 2, alignItems: "center", justifyContent: "center" }}>
          ...
          {hasNextEpisode && (
            <Focusable variant="playerButton" focusRadius={TV_OSD.boutonSecondaire / 2} phantomPressGuard ref={focus.registerButton("next")} onPress={onNextEpisode} {...focus.buttonProps("next")}>
              <View style={{ width: TV_OSD.boutonSecondaire, height: TV_OSD.boutonSecondaire, borderRadius: TV_OSD.boutonSecondaire / 2, alignItems: "center", justifyContent: "center" }}>
          ...
          {onEpisodes && (
            <Focusable variant="playerButton" focusRadius={TV_OSD.boutonSecondaire / 2} phantomPressGuard ref={focus.registerButton("episodes")} onPress={onEpisodes} {...focus.buttonProps("episodes")}>
              <View style={{ width: TV_OSD.boutonSecondaire, height: TV_OSD.boutonSecondaire, borderRadius: TV_OSD.boutonSecondaire / 2, alignItems: "center", justifyContent: "center" }}>
          ...
          <Focusable variant="playerButton" focusRadius={TV_OSD.boutonSecondaire / 2} phantomPressGuard ref={focus.registerButton("settings")} onPress={onSettings} {...focus.buttonProps("settings")}>
            <View style={{ width: TV_OSD.boutonSecondaire, height: TV_OSD.boutonSecondaire, borderRadius: TV_OSD.boutonSecondaire / 2, alignItems: "center", justifyContent: "center" }}>
