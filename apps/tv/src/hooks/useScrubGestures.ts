 ...
 * (`longLeft`/`longRight`, `rewind`/`fastForward`, remappés par MainActivity.kt)
 * déjà traités par useTVRemote → aucun geste à synthétiser ici.
 * La variante tvOS (`useScrubGestures.ios.ts`) alimente ces mêmes comportements
 * depuis les gestes pan de la Siri Remote.
 */
