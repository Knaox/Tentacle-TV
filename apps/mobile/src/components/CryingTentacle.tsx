...
/**
 * Poulpe pirate qui pleure — variante triste du TentacleLogo
 * Bouche inversée + larmes bleues
 */
export function CryingTentacle({ size = 120 }: CryingTentacleProps) {
  return (
    <Svg width={size} height={size * (560 / 512)} viewBox="0 0 512 560" fill="none">
      ...
      {/* === TEARS === */}
      {/* Left eye tears */}
      <Ellipse cx={200} cy={308} rx={5} ry={7} fill="url(#tearGrad)" opacity={0.8} />
      <Ellipse cx={195} cy={330} rx={4} ry={6} fill="url(#tearGrad)" opacity={0.6} />
      <Ellipse cx={192} cy={350} rx={3} ry={5} fill="url(#tearGrad)" opacity={0.4} />
      {/* Right eye tears */}
      <Ellipse cx={312} cy={308} rx={5} ry={7} fill="url(#tearGrad)" opacity={0.8} />
      <Ellipse cx={317} cy={330} rx={4} ry={6} fill="url(#tearGrad)" opacity={0.6} />
      <Ellipse cx={320} cy={350} rx={3} ry={5} fill="url(#tearGrad)" opacity={0.4} />
