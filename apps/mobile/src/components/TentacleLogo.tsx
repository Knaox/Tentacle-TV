...
export function TentacleLogo({ size = 120, crying = false }: TentacleLogoProps) {
  ...
  return (
    <Svg width={s} height={s} viewBox="0 0 240 240" fill="none">
      <Defs>
        <LinearGradient id="mgHead" x1="0" y1="26" x2="0" y2="140" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#C4B5FD" />
          <Stop offset="0.5" stopColor="#A855F7" />
          <Stop offset="1" stopColor="#D946EF" />
        </LinearGradient>
        <LinearGradient id="mgShine" x1="0" y1="34" x2="0" y2="86" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#FFFFFF" stopOpacity={0.28} />
          <Stop offset="1" stopColor="#FFFFFF" stopOpacity={0} />
        </LinearGradient>
        <LinearGradient id="mgScreen" x1="0" y1="104" x2="0" y2="196" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#341054" />
          <Stop offset="1" stopColor="#190933" />
        </LinearGradient>
        <LinearGradient id="mgFrame" x1="46" y1="26" x2="196" y2="214" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#A78BFA" />
          <Stop offset="0.42" stopColor="#D946EF" />
          <Stop offset="1" stopColor="#EC4899" />
        </LinearGradient>
        <LinearGradient id="mgArm" x1="0" y1="118" x2="0" y2="230" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#9333EA" />
          <Stop offset="0.4" stopColor="#D946EF" />
          <Stop offset="1" stopColor="#EC4899" />
        </LinearGradient>
        <LinearGradient id="mgPlay" x1="114" y1="134" x2="142" y2="166" gradientUnits="userSpaceOnUse">
      ...
      <Path d={HEAD_PATH} fill="url(#mgHead)" />
