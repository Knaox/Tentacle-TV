...
/**
 * Logo Tentacle TV — poulpe pirate avec chapeau tricorne
 * Converti depuis apps/web/public/tentacle-logo-pirate.svg
 */
export function TentacleLogo({ size = 120 }: { size?: number }) {
  return (
