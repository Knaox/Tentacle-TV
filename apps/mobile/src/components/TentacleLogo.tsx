 ...
 */
export function TentacleLogo({ size = 120, crying = false }: TentacleLogoProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 240 240" fill="none">
      <Defs>
        <LinearGradient id="mgMantle" x1="40" y1="54" x2="200" y2="186" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#A78BFA" />
          <Stop offset="0.5" stopColor="#8B5CF6" />
          <Stop offset="1" stopColor="#DB2777" />
        </LinearGradient>
        <LinearGradient id="mgArm" x1="0" y1="170" x2="0" y2="235" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#4C1D95" />
          <Stop offset="0.18" stopColor="#7C3AED" />
          <Stop offset="1" stopColor="#EC4899" />
        </LinearGradient>
        <LinearGradient id="mgArmBack" x1="0" y1="160" x2="0" y2="215" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#3B0F73" />
          <Stop offset="0.2" stopColor="#4C1D95" />
          <Stop offset="1" stopColor="#9D174D" />
        </LinearGradient>
        <LinearGradient id="mgTube" x1="0" y1="78" x2="0" y2="156" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#2E1065" />
          <Stop offset="1" stopColor="#160828" />
        </LinearGradient>
        <LinearGradient id="mgShine" x1="0" y1="54" x2="0" y2="110" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#FFFFFF" stopOpacity={0.3} />
          <Stop offset="1" stopColor="#FFFFFF" stopOpacity={0} />
        </LinearGradient>
        <LinearGradient id="mgGlass" x1="0" y1="78" x2="0" y2="130" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#FFFFFF" stopOpacity={0.22} />
          <Stop offset="1" stopColor="#FFFFFF" stopOpacity={0} />
        </LinearGradient>
        <LinearGradient id="mgHat" x1="0" y1="14" x2="0" y2="78" gradientUnits="userSpaceOnUse">
          <Stop offset="0" stopColor="#3C3450" />
          <Stop offset="1" stopColor="#15111F" />
        </LinearGradient>
        <LinearGradient id="mgBand" x1="76" y1="0" x2="164" y2="0" gradientUnits="userSpaceOnUse">
      ...
      <ArmGroup arms={[...ANTENNA_ARMS, ...BACK_ARMS]} stroke="url(#mgArmBack)" />
      <ArmGroup arms={FRONT_ARMS} stroke="url(#mgArm)" />
      ...
      <Path d={MANTLE_PATH} fill="url(#mgMantle)" />
      <Path d={SHINE_PATH} fill="url(#mgShine)" />
      <Path d={TUBE_PATH} fill="url(#mgTube)" />
      <Path d={GLASS_PATH} fill="url(#mgGlass)" />
      ...
      <G transform={HAT_TRANSFORM}>
        <Path d={HAT_PATH} fill="url(#mgHat)" />
        <Path
          d={HAT_BAND_PATH}
          stroke="url(#mgBand)"
          strokeWidth={6}
