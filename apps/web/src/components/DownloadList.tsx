import { useSeerrRequests } from "@tentacle/api-client";
...
export function DownloadList() {
  ...
  // Show only requests where media is processing (not yet fully available)
  ...
  return (
    <div className="space-y-3">
      {downloads.map((req) => {
        ...
        return (
          <div key={req.id} className="flex items-center gap-4 rounded-xl bg-white/5 px-5 py-4">
