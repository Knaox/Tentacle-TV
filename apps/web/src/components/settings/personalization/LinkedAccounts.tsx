 ...
 * ANONYMEMENT — l'explication est affichée) et état de la file de sync avec
 * resynchronisation manuelle. Le bloc indisponible (clé TMDB absente du
 * serveur) le dit au lieu de proposer un bouton qui échouera.
 */
