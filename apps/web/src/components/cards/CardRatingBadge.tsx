 ...
 */
export function CardRatingBadge({ rating, shown = true }: CardRatingBadgeProps) {
  ...
  return (
    <div
      className={`absolute bottom-2 left-2 z-10 flex items-center gap-1 rounded-md border border-white/20 bg-black/65 px-1.5 py-0.5 text-[11px] font-semibold leading-none text-white transition-opacity duration-150 ${
