...
// Étoile de notation et cœur « favori » plein : jaune/rouge décoratifs
// constants dans les deux thèmes (convention universelle, sans rapport avec
// les couleurs sémantiques de statut) — volontairement non migrés.
