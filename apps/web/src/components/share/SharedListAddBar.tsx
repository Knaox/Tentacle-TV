...
export function SharedListAddBar({ count, isAdding, added, onAdd }: Props) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 flex justify-center px-4 pb-5">
      <div className="flex items-center gap-4 rounded-full border border-white/12 bg-[#12121a]/95 px-5 py-3 shadow-2xl backdrop-blur-lg">
        ...
        <button
          ...
          className="rounded-full bg-[rgba(var(--brand-rgb),0.25)] px-4 py-2 text-sm font-semibold text-white ring-1 ring-[rgba(var(--brand-rgb),0.45)] transition-transform hover:scale-[1.03] disabled:opacity-50"
        >
