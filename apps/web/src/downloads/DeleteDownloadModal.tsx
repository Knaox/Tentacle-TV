...
export function DeleteDownloadModal({ title, busy, onConfirm, onClose }: DeleteDownloadModalProps) {
  ...
  return (
    <div
      ...
      role="alertdialog"
      aria-modal="true"
      aria-label={t("downloads:deleteConfirmTitle")}
    >
      ...
      >
        <div className="px-5 py-4">
          <h2 className="text-base font-bold text-content-primary">{t("downloads:deleteConfirmTitle")}</h2>
