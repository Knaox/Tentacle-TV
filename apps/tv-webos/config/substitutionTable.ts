...
const WEB = resolve(TARGET, "../web/src");
const UI = resolve(TARGET, "../../packages/ui/src");
const API = resolve(TARGET, "../../packages/api-client/src");
const CLIENT = resolve(TARGET, "client/src");
