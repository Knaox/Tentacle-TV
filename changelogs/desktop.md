...
- **Un seul bouton, blanc, partout.** Il compte, il se refuse d'une croix, et il dit où il mène : pendant un générique de fin suivi d'une scène, il propose de sauter jusqu'à la scène, pas jusqu'à l'épisode suivant — et si le générique reprend APRÈS la scène, il propose alors de terminer la lecture. La croix ne paraît que sur l'image nue — elle arrête le décompte et retire le bouton — sans jamais vous priver du geste : montrez les commandes, il est là
- **Le générique de fin se règle séparément sur les films et sur les séries**, et les films le passent tout seuls d'origine — le bouton mène alors à la scène post-générique. Un film ne se ferme jamais tout seul pendant son générique ; en revanche, si le générique reprend APRÈS la scène, il peut décompter et terminer la lecture
...
- **One button, white, everywhere.** It counts down, it can be refused with a cross, and it says where it leads: during closing credits followed by a scene, it offers to skip to the scene, not to the next episode — and if the credits resume AFTER the scene, it then offers to end playback. The cross only appears over the bare picture — it stops the countdown and takes the button away — without ever denying you the gesture: bring up the controls and it is there
- **Closing credits are set separately for films and for series**, and films skip them on their own out of the box — the button then leads to the post-credit scene. A film never closes on its own during its credits; but if the credits resume AFTER the scene, it can count down and end playback
